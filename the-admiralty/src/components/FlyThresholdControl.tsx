...
export default function FlyThresholdControl({ value, onChange, label = 'Soglia Fly' }: Props) {
  return (
    <div className="flex items-center gap-2" title="Velocità minima (sog_min) per classificare la manovra come Fly. Sotto la soglia: Touch.">
